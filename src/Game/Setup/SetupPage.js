...
const SetupPage = () => {
  ...
  return (
    <div className="pt-8 pb-8 text sm:h-fill bg-setup flex flex-col items-center text-center">
      ...
      <div className="sm:mt-8 flex flex-col sm:grid sm:grid-flow-col sm:grid-cols-3">
        ...
        <div className="flex justify-center" >
          <img
            className="h-36 sm:h-44 border-2 border-pink-400"
            src={Maze}
            alt="maze"
          />
        </div>
        ...
        <p className="mt-6 text-2xl">BEWARE OF THE <span className="text-red-600 bg-black rounded px-1">SKULL MONSTER</span>!!!  
        </p>
